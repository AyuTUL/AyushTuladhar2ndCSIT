    ...
    switch(a)
    {
        case 1:
            ...
            if(ua2.name==ub2.name)
                ...
                cout<<"A : "<<"{"<<"("<<ua0.name<<","<<ua0.score<<")"<<"("<<ua1.name<<","<<ua1.score<<")"<<"("<<ua2.name<<","<<ua2.score<<")"<<"}"<<endl;
                cout<<"B : "<<"{"<<"("<<ub0.name<<","<<ub0.score<<")"<<"("<<ub1.name<<","<<ub1.score<<")"<<"("<<ub2.name<<","<<ub2.score<<")"<<"}"<<endl;
                cout<<"A + B : "<<"{"<<"("<<a1.name<<","<<a1.score<<")"<<"("<<a2.name<<","<<a2.score<<")"<<"("<<a3.name<<","<<a3.score<<")"<<"}"<<endl;
                    break;
                }
            ...
            case 3:
                {
                  ...
                  cout<<"A : "<<"{"<<"("<<ua0.name<<","<<ua0.score<<")"<<"("<<ua1.name<<","<<ua1.score<<")"<<"("<<ua2.name<<","<<ua2.score<<")"<<"}"<<endl;
               // cout<<"B : "<<"{"<<"("<<ub0.name<<","<<ub0.score<<")"<<"("<<ub1.name<<","<<ub1.score<<")"<<"("<<ub2.name<<","<<ub2.score<<")"<<"}"<<endl;
                cout<<"A' : "<<"{"<<"("<<a1.name<<","<<a1.score<<")"<<"("<<a2.name<<","<<a2.score<<")"<<"("<<a3.name<<","<<a3.score<<")"<<"}"<<endl;
